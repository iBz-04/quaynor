...
```typescript
import { Chat, SamplerPresets } from "react-native-quaynor";
...
```typescript
import { Chat, SamplerBuilder } from "react-native-quaynor";
