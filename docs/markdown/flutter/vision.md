...
final response2 = await chat.askWithPrompt(quaynor.Prompt([
  quaynor.TextPart("Tell me what you see in the image."),
  quaynor.ImagePart("./dog.png"),
  quaynor.TextPart("Also tell me what you hear in the audio"),
  quaynor.AudioPart("./sound.mp3"),
])).completed();
```
