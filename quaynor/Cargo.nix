...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "quaynor-flutter" = rec {
        crateName = "quaynor-flutter";
        version = "1.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./flutter/rust; };
        libName = "quaynor_flutter";type = [ "cdylib" ];
        dependencies = [
          {
      ...
      "quaynor-python" = rec {
        ...
        libName = "quaynor_python";type = [ "cdylib" ];
        dependencies = [
          {
            name = "futures";
            packageId = "futures";
