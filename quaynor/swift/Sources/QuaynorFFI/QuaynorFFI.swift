...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_quaynor_uniffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_quaynor_uniffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureQuaynorUniffiInitialized()
...
open class RustChat: RustChatProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rustchat(self.handle, $0) }
    }
    /**
...
open func ask(message: String) -> RustTokenStream  {
    ...
    uniffi_quaynor_uniffi_fn_method_rustchat_ask(
...
open func askWithPrompt(parts: [PromptPart]) -> RustTokenStream  {
    return try!  FfiConverterTypeRustTokenStream_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_rustchat_ask_with_prompt(
            self.uniffiCloneHandle(),
...
open func getChatHistory()async throws  -> [Message]  {
    return
        try  await uniffiRustCallAsync(
            ...
            completeFunc: ffi_quaynor_uniffi_rust_future_complete_rust_buffer,
...
open func resetContext(systemPrompt: String?, tools: [RustTool]?)async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustchat_reset_context(
                    self.uniffiCloneHandle(),
            ...
            completeFunc: ffi_quaynor_uniffi_rust_future_complete_void,
            freeFunc: ffi_quaynor_uniffi_rust_future_free_void,
            liftFunc: { $0 },
            errorHandler: FfiConverterTypeQuaynorError_lift
        )
}
...
open func setChatHistory(messages: [Message])async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustchat_set_chat_history(
                    self.uniffiCloneHandle(),
...
open func setTools(tools: [RustTool])async throws   {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustchat_set_tools(
                    self.uniffiCloneHandle(),
...
open func tokenize(message: String)async throws  -> [Int32?]  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustchat_tokenize(
                    self.uniffiCloneHandle(),
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rustcrossencoder(self.handle, $0) }
    }
    /**
...
open func rank(query: String, documents: [String])async throws  -> [Float]  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustcrossencoder_rank(
                    self.uniffiCloneHandle(),
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rustencoder(self.handle, $0) }
    }
    /**
...
open func encode(text: String)async throws  -> [Float]  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_method_rustencoder_encode(
                    self.uniffiCloneHandle(),
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rustmodel(self.handle, $0) }
    }
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rusttokenstream(self.handle, $0) }
    }
    // No primary constructor declared for this class.
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_rusttool(self.handle, $0) }
    }
    /**
...
public convenience init(name: String, description: String, parameters: [ToolParameter], callback: RustToolCallback) {
    let handle =
        try! rustCall() {
    uniffi_quaynor_uniffi_fn_constructor_rusttool_new(
...
public static func newAsync(name: String, description: String, parameters: [ToolParameter]) -> RustTool  {
    ...
    uniffi_quaynor_uniffi_fn_constructor_rusttool_new_async(
        FfiConverterString.lower(name),
        FfiConverterString.lower(description),
...
open func getSchemaJson() -> String  {
    ...
    uniffi_quaynor_uniffi_fn_method_rusttool_get_schema_json(
            self.uniffiCloneHandle(),$0
    )
})
}
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_samplerbuilder(self.handle, $0) }
    }
    /**
...
public convenience init() {
    let handle =
        try! rustCall() {
    uniffi_quaynor_uniffi_fn_constructor_samplerbuilder_new($0
    )
}
    self.init(unsafeFromHandle: handle)
}
...
open func dist() -> SamplerConfig  {
    ...
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_dist(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func dry(multiplier: Float, base: Float, allowedLength: Int32, penaltyLastN: Int32, seqBreakers: [String]) -> SamplerBuilder  {
    ...
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_dry(
            self.uniffiCloneHandle(),
...
open func grammar(grammar: String, triggerOn: String?, root: String) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_grammar(
            self.uniffiCloneHandle(),
...
open func greedy() -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_greedy(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func minP(minP: Float, minKeep: UInt32) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_min_p(
            self.uniffiCloneHandle(),
...
open func penalties(penaltyLastN: Int32, penaltyRepeat: Float, penaltyFreq: Float, penaltyPresent: Float) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_penalties(
            self.uniffiCloneHandle(),
        FfiConverterInt32.lower(penaltyLastN),
...
open func topK(topK: Int32) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_top_k(
            self.uniffiCloneHandle(),
...
open func topP(topP: Float, minKeep: UInt32) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_top_p(
            self.uniffiCloneHandle(),
...
open func typicalP(typP: Float, minKeep: UInt32) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_typical_p(
            self.uniffiCloneHandle(),
...
open func xtc(xtcProbability: Float, xtcThreshold: Float, minKeep: UInt32) -> SamplerBuilder  {
    return try!  FfiConverterTypeSamplerBuilder_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_method_samplerbuilder_xtc(
            self.uniffiCloneHandle(),
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_quaynor_uniffi_fn_clone_samplerconfig(self.handle, $0) }
    }
    // No primary constructor declared for this class.
...
public static func fromJson(jsonStr: String)throws  -> SamplerConfig  {
    return try  FfiConverterTypeSamplerConfig_lift(try rustCallWithError(FfiConverterTypeQuaynorError_lift) {
...
open func toJson()throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeQuaynorError_lift) {
    uniffi_quaynor_uniffi_fn_method_samplerconfig_to_json(
            self.uniffiCloneHandle(),$0
    )
})
}
...
public struct Asset: Equatable, Hashable, Codable {
...
public struct CachedModel: Equatable, Hashable, Codable {
    public var path: String
...
public struct ChatStats: Equatable, Hashable, Codable {
    public var contextSize: UInt32
    public var contextUsed: UInt32
    public var historyCount: UInt32
    public var toolCount: UInt32
    public var templateVariableCount: UInt32

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(contextSize: UInt32, contextUsed: UInt32, historyCount: UInt32, toolCount: UInt32, templateVariableCount: UInt32) {
...
public struct FfiConverterTypeChatStats: FfiConverterRustBuffer {
    ...
    public static func write(_ value: ChatStats, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt32.write(value.historyCount, into: &buf)
        FfiConverterUInt32.write(value.toolCount, into: &buf)
        FfiConverterUInt32.write(value.templateVariableCount, into: &buf)
    }
}
 ...
 */
public struct PendingToolCall: Equatable, Hashable, Codable {
...
public struct ToolParameter: Equatable, Hashable, Codable {
    public var name: String
    /**
...
#if compiler(>=6)
extension QuaynorError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeQuaynorError: FfiConverterRustBuffer {
    typealias SwiftType = QuaynorError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QuaynorError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuaynorError_lift(_ buf: RustBuffer) throws -> QuaynorError {
    return try FfiConverterTypeQuaynorError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuaynorError_lower(_ value: QuaynorError) -> RustBuffer {
    return FfiConverterTypeQuaynorError.lower(value)
}
...
private func uniffiCallbackInitRustDownloadProgressCallback() {
    uniffi_quaynor_uniffi_fn_init_callback_vtable_rustdownloadprogresscallback(UniffiCallbackInterfaceRustDownloadProgressCallback.vtable)
}
...
private func uniffiCallbackInitRustToolCallback() {
    uniffi_quaynor_uniffi_fn_init_callback_vtable_rusttoolcallback(UniffiCallbackInterfaceRustToolCallback.vtable)
}
...
public func cosineSimilarity(a: [Float], b: [Float]) -> Float  {
    ...
    uniffi_quaynor_uniffi_fn_func_cosine_similarity(
...
public func downloadModel(modelPath: String, headers: [String: String]?, onDownloadProgress: RustDownloadProgressCallback?)async throws  -> String  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_func_download_model(FfiConverterString.lower(modelPath),FfiConverterOptionDictionaryStringString.lower(headers),FfiConverterOptionCallbackInterfaceRustDownloadProgressCallback.lower(onDownloadProgress)
                )
            },
            pollFunc: ffi_quaynor_uniffi_rust_future_poll_rust_buffer,
            completeFunc: ffi_quaynor_uniffi_rust_future_complete_rust_buffer,
...
public func getCachedModels()throws  -> [CachedModel]  {
    return try  FfiConverterSequenceTypeCachedModel.lift(try rustCallWithError(FfiConverterTypeQuaynorError_lift) {
    uniffi_quaynor_uniffi_fn_func_get_cached_models($0
    )
})
}
/**
...
public func loadModel(modelPath: String, useGpu: Bool, projectionModelPath: String?, onDownloadProgress: RustDownloadProgressCallback?)async throws  -> RustModel  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_quaynor_uniffi_fn_func_load_model(FfiConverterString.lower(modelPath),FfiConverterBool.lower(useGpu),FfiConverterOptionString.lower(projectionModelPath),FfiConverterOptionCallbackInterfaceRustDownloadProgressCallback.lower(onDownloadProgress)
                )
            },
            pollFunc: ffi_quaynor_uniffi_rust_future_poll_u64,
            completeFunc: ffi_quaynor_uniffi_rust_future_complete_u64,
            freeFunc: ffi_quaynor_uniffi_rust_future_free_u64,
...
public func samplerPresetDefault() -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_default($0
    )
})
}
/**
...
public func samplerPresetDry() -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_dry($0
    )
})
}
/**
...
public func samplerPresetGrammar(grammar: String) -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_grammar(
...
public func samplerPresetGreedy() -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_greedy($0
    )
})
}
/**
...
public func samplerPresetJson() -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_json($0
    )
})
}
/**
...
public func samplerPresetTemperature(temperature: Float) -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_temperature(
        FfiConverterFloat.lower(temperature),$0
    )
})
}
...
public func samplerPresetTopK(topK: Int32) -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_top_k(
        FfiConverterInt32.lower(topK),$0
    )
})
}
...
public func samplerPresetTopP(topP: Float) -> SamplerConfig  {
    return try!  FfiConverterTypeSamplerConfig_lift(try! rustCall() {
    uniffi_quaynor_uniffi_fn_func_sampler_preset_top_p(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_quaynor_uniffi_uniffi_contract_version()
    ...
    if (uniffi_quaynor_uniffi_checksum_func_get_cached_models() != 5846) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_load_model() != 54145) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_default() != 36783) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_dry() != 15463) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_grammar() != 23570) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_greedy() != 5933) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_json() != 60102) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_temperature() != 22785) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_top_k() != 12670) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_func_sampler_preset_top_p() != 52041) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_ask() != 35577) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_ask_with_prompt() != 57788) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_get_chat_history() != 20300) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_get_sampler_config_json() != 39075) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_get_stats() != 46175) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_get_system_prompt() != 9666) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_get_template_variables() != 1092) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_reset_context() != 33907) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_reset_history() != 30902) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_set_chat_history() != 7701) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_set_sampler_config() != 42014) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_set_system_prompt() != 23253) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_set_template_variable() != 6787) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_set_tools() != 57379) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_stop_generation() != 65399) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustchat_tokenize() != 44194) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustcrossencoder_rank() != 43543) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustcrossencoder_rank_and_sort_json() != 39936) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_quaynor_uniffi_checksum_method_rusttokenstream_next_token() != 63916) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rusttool_get_schema_json() != 33044) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rusttool_next_pending_call() != 43580) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rusttool_resolve_pending_call() != 12521) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_dist() != 9165) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_dry() != 46243) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_grammar() != 59568) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_greedy() != 28820) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_min_p() != 27860) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_mirostat_v1() != 8947) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_mirostat_v2() != 49669) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_penalties() != 12656) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_temperature() != 32019) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_top_k() != 2059) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_top_p() != 19167) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_typical_p() != 53696) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_samplerbuilder_xtc() != 43477) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_quaynor_uniffi_checksum_constructor_rusttool_new_async() != 35229) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_constructor_samplerbuilder_new() != 45133) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_constructor_samplerconfig_from_json() != 19789) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rustdownloadprogresscallback_on_download_progress() != 41893) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_quaynor_uniffi_checksum_method_rusttoolcallback_call() != 48075) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureQuaynorUniffiInitialized() {
