...
fn init_logging() {
    ...
    INIT.call_once(|| {
        ...
        log::info!("Quaynor logging initialized");
    });
}
...
#[uniffi(flat_error)]
pub enum QuaynorError {
    #[error("{message}")]
    Error { message: String },
}

impl From<String> for QuaynorError {
    fn from(message: String) -> Self {
        QuaynorError::Error { message }
    }
}
...
impl From<&quaynor::chat::Role> for Role {
    fn from(r: &quaynor::chat::Role) -> Self {
        match r {
            quaynor::chat::Role::User => Role::User,
            quaynor::chat::Role::Assistant => Role::Assistant,
            quaynor::chat::Role::System => Role::System,
            quaynor::chat::Role::Tool => Role::Tool,
        }
    }
}

impl From<&Role> for quaynor::chat::Role {
    fn from(r: &Role) -> Self {
        match r {
            Role::User => quaynor::chat::Role::User,
            Role::Assistant => quaynor::chat::Role::Assistant,
            Role::System => quaynor::chat::Role::System,
            Role::Tool => quaynor::chat::Role::Tool,
        }
    }
}
...
fn core_message_to_uniffi(m: &quaynor::chat::Message) -> Message {
    match m {
        quaynor::chat::Message::Message {
            role,
            content,
            assets,
        } => Message::Message {
        ...
        quaynor::chat::Message::ToolCalls {
            role,
            content,
            tool_calls,
        } => Message::ToolCalls {
...
fn uniffi_message_to_core(m: &Message) -> Result<quaynor::chat::Message, QuaynorError> {
    match m {
        Message::Message {
            role,
            content,
            assets,
        } => Ok(quaynor::chat::Message::Message {
            role: quaynor::chat::Role::from(role),
            content: content.clone(),
            assets: assets
                .iter()
                .map(|a| quaynor::chat::Asset {
                    id: a.id.clone(),
        ...
        Message::ToolResp {
            ...
            name,
            content,
        } => Ok(quaynor::chat::Message::ToolResp {
            role: quaynor::chat::Role::from(role),
            name: name.clone(),
            content: content.clone(),
        }),
...
#[derive(uniffi::Object)]
pub struct RustChat {
    inner: quaynor::chat::ChatHandleAsync,
}
...
impl RustChat {
    ...
    pub async fn reset_history(&self) -> Result<(), QuaynorError> {
        self.inner
            .reset_history()
            .await
            .map_err(|e| QuaynorError::Error {
    ...
    pub async fn get_chat_history(&self) -> Result<Vec<Message>, QuaynorError> {
        let messages = self
            .inner
            .get_chat_history()
            .await
    ...
    pub async fn set_chat_history(&self, messages: Vec<Message>) -> Result<(), QuaynorError> {
        let core_messages: Result<Vec<_>, QuaynorError> =
    ...
    pub async fn get_system_prompt(&self) -> Result<Option<String>, QuaynorError> {
        self.inner
            .get_system_prompt()
            .await
            .map_err(|e| QuaynorError::Error {
    ...
    pub async fn set_tools(&self, tools: Vec<Arc<RustTool>>) -> Result<(), QuaynorError> {
        let core_tools: Vec<quaynor::tool_calling::Tool> =
    ...
    pub async fn get_template_variables(&self) -> Result<HashMap<String, bool>, QuaynorError> {
        self.inner
    ...
    pub async fn set_sampler_config(&self, sampler: &SamplerConfig) -> Result<(), QuaynorError> {
        self.inner
    ...
    pub async fn get_sampler_config_json(&self) -> Result<String, QuaynorError> {
        let config = self
            .inner
            .get_sampler_config()
            .await
        ...
        serde_json::to_string(&config).map_err(|e| QuaynorError::Error {
            message: e.to_string(),
        })
    }
}
...
pub struct RustTokenStream {
    ...
    inner: tokio::sync::Mutex<quaynor::chat::TokenStreamAsync>,
}
...
impl RustTokenStream {
    ...
    pub async fn completed(&self) -> Result<String, QuaynorError> {
        self.inner
            .lock()
            .await
            .completed()
...
impl RustTool {
    ...
    pub fn new(
        ...
        let tool = quaynor::tool_calling::Tool::new(name, description, schema, Arc::new(wrapped));
        Arc::new(Self {
            inner: tool,
            pending_rx: None,
            resolvers: None,
...
pub struct RustEncoder {
    inner: quaynor::encoder::EncoderAsync,
}
...
impl RustEncoder {
    ...
    pub async fn encode(&self, text: String) -> Result<Vec<f32>, QuaynorError> {
        self.inner
            .encode(text)
            .await
            .map_err(|e| QuaynorError::Error {
...
pub struct RustCrossEncoder {
    inner: quaynor::crossencoder::CrossEncoderAsync,
}
...
impl RustCrossEncoder {
    ...
    pub async fn rank_and_sort_json(
        ...
        serde_json::to_string(&results).map_err(|e| QuaynorError::Error {
            message: e.to_string(),
        })
    }
}
...
pub struct SamplerConfig {
    inner: quaynor::sampler_config::SamplerConfig,
}

#[uniffi::export]
impl SamplerConfig {
    /// Serialize the sampler configuration to a JSON string.
    pub fn to_json(&self) -> Result<String, QuaynorError> {
        serde_json::to_string(&self.inner).map_err(|e| QuaynorError::Error {
            message: e.to_string(),
        })
    }
    ...
    #[uniffi::constructor]
    pub fn from_json(json_str: String) -> Result<Arc<Self>, QuaynorError> {
        let inner: quaynor::sampler_config::SamplerConfig = serde_json::from_str(&json_str)
            .map_err(|e| QuaynorError::Error {
                message: e.to_string(),
            })?;
...
impl SamplerBuilder {
    ...
    pub fn new() -> Arc<Self> {
        Arc::new(Self {
            inner: quaynor::sampler_config::SamplerConfig::default(),
        })
    }
    ...
    pub fn top_k(&self, top_k: i32) -> Arc<SamplerBuilder> {
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::TopK { top_k }),
        })
    }
    ...
    pub fn top_p(&self, top_p: f32, min_keep: u32) -> Arc<SamplerBuilder> {
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::TopP { top_p, min_keep }),
        })
    }
    ...
    pub fn min_p(&self, min_p: f32, min_keep: u32) -> Arc<SamplerBuilder> {
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::MinP { min_p, min_keep }),
        })
    }
    ...
    pub fn temperature(&self, temperature: f32) -> Arc<SamplerBuilder> {
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::Temperature { temperature }),
        })
    }
    ...
    pub fn xtc(
        ...
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::XTC {
                    xtc_probability,
                    xtc_threshold,
                    min_keep,
                }),
    ...
    pub fn typical_p(&self, typ_p: f32, min_keep: u32) -> Arc<SamplerBuilder> {
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::TypicalP { typ_p, min_keep }),
        })
    }
    ...
    pub fn grammar(
        ...
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::Grammar {
                    grammar,
                    trigger_on,
                    root,
                }),
    ...
    pub fn dry(
        ...
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::DRY {
                    multiplier,
                    base,
                    allowed_length,
                    penalty_last_n,
    ...
    pub fn penalties(
        ...
        Arc::new(SamplerBuilder {
            inner: self
                .inner
                .clone()
                .shift(quaynor::sampler_config::ShiftStep::Penalties {
                    penalty_last_n,
                    penalty_repeat,
                    penalty_freq,
                    penalty_present,
    ...
    pub fn dist(&self) -> Arc<SamplerConfig> {
        Arc::new(SamplerConfig {
            inner: self
                .inner
                .clone()
                .sample(quaynor::sampler_config::SampleStep::Dist),
        })
    }
    ...
    pub fn greedy(&self) -> Arc<SamplerConfig> {
        Arc::new(SamplerConfig {
            inner: self
                .inner
                .clone()
                .sample(quaynor::sampler_config::SampleStep::Greedy),
        })
    }
    ...
    pub fn mirostat_v1(&self, tau: f32, eta: f32, m: i32) -> Arc<SamplerConfig> {
        Arc::new(SamplerConfig {
            inner: self
                .inner
                .clone()
                .sample(quaynor::sampler_config::SampleStep::MirostatV1 { tau, eta, m }),
        })
    }
    ...
    pub fn mirostat_v2(&self, tau: f32, eta: f32) -> Arc<SamplerConfig> {
        Arc::new(SamplerConfig {
            inner: self
                .inner
                .clone()
                .sample(quaynor::sampler_config::SampleStep::MirostatV2 { tau, eta }),
        })
    }
}
...
pub fn sampler_preset_top_k(top_k: i32) -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::top_k(top_k),
    })
}
...
pub fn sampler_preset_top_p(top_p: f32) -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::top_p(top_p),
    })
}
...
pub fn sampler_preset_greedy() -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::greedy(),
    })
}
...
pub fn sampler_preset_temperature(temperature: f32) -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::temperature(temperature),
    })
}
...
pub fn sampler_preset_dry() -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::dry(),
    })
}
...
pub fn sampler_preset_json() -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::json(),
    })
}
...
pub fn sampler_preset_grammar(grammar: String) -> Arc<SamplerConfig> {
    Arc::new(SamplerConfig {
        inner: quaynor::sampler_config::SamplerPresets::grammar(grammar),
    })
}
