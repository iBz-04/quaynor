...
This document defines which types in the `quaynor-uniffi` crate are intended to be wrapped by language-specific bindings (React Native, Swift, Kotlin, etc.) and which should be re-exported directly.
