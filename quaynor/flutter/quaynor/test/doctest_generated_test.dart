  ...
  group('Doctest: Flutter Docs', () {
    setUpAll(() async {
      ...
      if (modelPath != null) {
        ...
        final hfCache = Directory('$cacheHome/quaynor/models/bartowski/Qwen_Qwen3-0.6B-GGUF');
    ...
    tearDownAll(() async {
      ...
      final cacheHome = Platform.environment['XDG_CACHE_HOME'] ?? '${Platform.environment['HOME']}/.cache';
      final hfLink = Link('$cacheHome/quaynor/models/bartowski/Qwen_Qwen3-0.6B-GGUF/Qwen_Qwen3-0.6B-Q4_K_M.gguf');
      if (hfLink.existsSync()) {
        hfLink.deleteSync();
      }
    });
