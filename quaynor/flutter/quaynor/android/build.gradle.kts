...
val resolveNativeLibraries by tasks.registering {
    description = "Resolves Quaynor native libraries using the Dart resolution script"

    val jniLibsDir = layout.buildDirectory.dir("jniLibs")
    val cacheDir = layout.buildDirectory.dir("quaynor-cache")
    ...
    doLast {
        ...
        targetAbis.forEach { abi ->
            ...
            if (execResult.exitValue != 0) {
                throw GradleException("Failed to resolve Quaynor library for $abi:\n$stderrText")
            }
