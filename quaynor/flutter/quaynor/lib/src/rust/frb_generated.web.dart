...
class QuaynorWire implements BaseWire {
  QuaynorWire.fromExternalLibrary(ExternalLibrary lib);
...
@JS('wasm_bindgen')
external QuaynorWasmModule get wasmModule;

@JS()
@anonymous
extension type QuaynorWasmModule._(JSObject _) implements JSObject {
  external void
  rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAsset(
    int ptr,
  );
