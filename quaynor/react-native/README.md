# Quaynor React Native

Quaynor is a React Native library for running large language models locally and offline on iOS and Android.
...
```typescript
import { Model } from "react-native-quaynor";
...
```typescript
import { Chat, Prompt } from "react-native-quaynor";
