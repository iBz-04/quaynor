# Quaynor React Native — iOS podspec
...
framework_name = "QuaynorFramework.xcframework"
...
puts "[Quaynor] Downloading xcframework from #{url}"
...
puts "[Quaynor] xcframework ready at #{framework_dir}"
