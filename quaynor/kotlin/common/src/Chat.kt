...
import uniffi.quaynor.ChatStats
import uniffi.quaynor.RustChat as InternalRustChat
import uniffi.quaynor.SamplerConfig
...
class Chat(
    ...
    fun ask(prompt: Prompt): TokenStream = TokenStream(inner.askWithPrompt(prompt.parts))
    ...
    // ai.quaynor — the generated uniffi.quaynor.Message.Tool variant would
    // otherwise clash with the top-level ai.quaynor.Tool class.
